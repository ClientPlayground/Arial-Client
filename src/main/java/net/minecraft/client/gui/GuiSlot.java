...
import me.kaimson.arialclient.gui.screen.smoothscrolling.CustomGuiSlot;
import me.kaimson.arialclient.gui.screen.smoothscrolling.GuiSlotScroller;
import me.kaimson.arialclient.utils.Returner;
...
//            this.bindAmountScrolled();
        ...
        if (!lock && this.isMouseYWithinSlotBounds(this.mouseY))
        {
    ...
    public void handleMouseInput()
    {
        ...
        else
        {
            ...
            if (i2 != 0)
            {
                ...
                if (this.amountScrolled <= this.func_148135_f() && i2 < 0.0)
                {
