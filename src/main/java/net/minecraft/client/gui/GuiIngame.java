...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EventHandler.call(new TickEvent.RenderTick.Overlay(TickEvent.Phase.START, partialTicks));
        ...
        if (this.showCrosshair() && mc.gameSettings.thirdPersonView == 0)
        {
            if (Feature.CROSSHAIR.isEnabled()) {
                Crosshair.INSTANCE.render(scaledresolution.getScaledWidth() / 2, scaledresolution.getScaledHeight() / 2);
            } else {
        ...
        EventHandler.call(new TickEvent.RenderTick.Overlay(TickEvent.Phase.END, partialTicks));
