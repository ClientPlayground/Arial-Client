...
import me.kaimson.arialclient.gui.buttons.ButtonClose;
import me.kaimson.arialclient.gui.buttons.ButtonImage;
...
/*        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));*/
        this.buttonList.add(new ButtonImage(0, width / 2 - 7, height - 10 - 16, 14, 14, "settings"));
        this.buttonList.add(new ButtonImage(5, width / 2 - 7 - 14 - 4, height - 10 - 16, 14, 14, "language"));
        this.buttonList.add(new ButtonImage(-3, width / 2 - 7 + 14 + 4, height - 10 - 16, 14, 14, "cosmetics"));
        this.buttonList.add(new ButtonClose(4, width - 6 - 15,  6, 15, 15));
/*        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + 12));*/
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 60, p_73969_1_, 120, 20, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 60, p_73969_1_ + p_73969_2_ * 1 + 2, 120, 20, I18n.format("menu.multiplayer", new Object[0])));
...
/*            this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));*/
    ...
    private final ResourceLocation BACKGROUND = new ResourceLocation(Client.resourceLocation + "/background.png");
...
/*        GlStateManager.pushMatrix();
        ...
        GlStateManager.popMatrix();*/
        String s = Client.name + " 1.8.9-beta";
