...
import me.kaimson.arialclient.event.events.*;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
                ...
                while (this.running) {
                    if (!this.hasCrashed || this.crashReporter == null) {
                        try {
                            ...
                            if (!Feature.FASTER_WORLD_LOADING.isEnabled())
                                System.gc();
                        }
                    } else {
    ...
    private void startGame() throws LWJGLException, IOException {
        EventHandler.call(new InitializationEvent.Pre());
        this.gameSettings = new GameSettings(this, this.mcDataDir);
        EventHandler.call(new SettingsRegisteredEvent());
        ...
        EventHandler.call(new InitializationEvent());
        ...
        EventHandler.call(new InitializationEvent.Post());
    }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Minecraft 1.8.9 - " + Client.name);
...
/*                inputstream = this.mcDefaultResourcePack.getInputStreamAssets(new ResourceLocation("icons/icon_16x16.png"));
                ...
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("arialclient/logo32.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("arialclient/logo64.png"));
                inputstream2 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("arialclient/logo128.png"));

                if (inputstream != null && inputstream1 != null && inputstream2 != null) {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        EventHandler.call(new GuiScreenEvent.Open(guiScreenIn));
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            EventHandler.call(new TickEvent.RenderTick(TickEvent.Phase.START, timer.renderPartialTicks));
            this.mcProfiler.endStartSection("gameRenderer");
            this.entityRenderer.updateCameraAndRender(this.timer.renderPartialTicks, i);
            this.mcProfiler.endSection();
            EventHandler.call(new TickEvent.RenderTick(TickEvent.Phase.END, timer.renderPartialTicks));
        }
    ...
    public void runTick() throws IOException {
        ...
        EventHandler.call(new TickEvent.ClientTick(TickEvent.Phase.START, timer.renderPartialTicks));
        ...
        EventHandler.call(new TickEvent.ClientTick(TickEvent.Phase.END, timer.renderPartialTicks));
    ...
    public void dispatchKeypresses() {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent()) {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls) this.currentScreen).time <= getSystemTime() - 20L) {
                if (Keyboard.getEventKeyState()) {
                    EventHandler.call(new KeyTypeEvent(i));
