...
public class ItemRenderer
{
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        {
            if (Feature.ANIMATIONS_BOW.isEnabled())
            {
                if (this.mc != null && this.mc.thePlayer != null && mc.thePlayer.getItemInUse() != null && mc.thePlayer.getItemInUse().getItem() != null && Item.getIdFromItem(mc.thePlayer.getItemInUse().getItem()) == 261)
                {
                    GlStateManager.translate(-0.01F, 0.05F, -0.06F);
                }
            }

            if (Feature.ANIMATIONS_ROD.isEnabled())
            {
                ...
                {
                    if (Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 346 ||
                            Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 398)
                    {
            ...
            if (Feature.ANIMATIONS_SWING.isEnabled())
            {
                if (this.mc != null && mc.thePlayer != null && mc.thePlayer.isSwingInProgress && mc.thePlayer.getCurrentEquippedItem() != null && !mc.thePlayer.isEating() && !mc.thePlayer.isBlocking())
                {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    float var10 = 0.0F;
                    if (Feature.ANIMATIONS.isEnabled())
                        if (Feature.ANIMATIONS_BLOCKHIT.isEnabled())
                            var10 = f1;
                    ...
                    switch (enumaction)
                    {
                        ...
                        case DRINK:
                            ...
                            this.transformFirstPersonItem(f, var10);
                            if (Feature.ANIMATIONS.isEnabled())
                                if (Feature.ANIMATIONS_EAT.isEnabled()) {
